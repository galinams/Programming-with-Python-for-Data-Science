...
#
# .. your code here ..
X = pd.read_csv("C:/DAT207x/Programming with Python for Data Science/Module6/Datasets/wheat.data", index_col='id')
print X.head()
...
d_tree = tree.DecisionTreeClassifier(max_depth=2, random_state=2)
...
benchmark(d_tree, X_train, X_test, y_train, y_test, 'Decision Tree')
drawPlots(d_tree, X_train, X_test, y_train, y_test, 'Decision Tree')
